...
| --- | --- |
| **Live vessel map** | Real-time vessel positions with risk-based coloring and heading indicators |
...
| **Operations center** | Source health monitoring, ingestion controls, and data quality visibility |
...
| --- | --- |
| `/map` | Live vessel map — the main workspace |
...
| `/ports` | Port activity |
| `/operations` | System health and ingestion controls |
